    ...
    try {
      ...
      switch (activeTab) {
        case "admin":
          ...
          res = await fetch(`https://waterfall-api-nnsgg.ondigitalocean.app/api/admin/deleteAdmin/${userId}`, {
            method: "DELETE",
            headers: {
        ...
        case "recruiter":
          ...
          res = await fetch(`https://waterfall-api-nnsgg.ondigitalocean.app/api/admin/deleteRecruiter/${aid}/${userId}`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`,
